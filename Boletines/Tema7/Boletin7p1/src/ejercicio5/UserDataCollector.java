...
public class UserDataCollector {
	...
	/**
	 * Muestra un mensaje por pantalla y solicita un entero comprendido entre min y
	 * max. Repite la operaci�n hasta que se introduce un n�mero entero comprendido
	 * entre min y max.
	 * 
	 * @param mensaje El mensaje que se mostrar�
	...
	/**
	 * Muestra un mensaje por pantalla y solicita una cadena. Repite la operaci�n
	 * hasta que se introduce una cadena v�lida.
	 * 
	 * @param mensaje El mensaje que se mostrar�
	...
	/**
	 * Muestra un mensaje por pantalla y solicita una cadena que debe estar
	 * comprendida entre una serie de opciones v�lidas Repite la operaci�n hasta que
	 * se introduce una cadena v�lida.
	 * 
	 * @param mensaje  El mensaje que se mostrar�
