...
//		File dir = new File(currentDir, fichero);
	...
	private static void mostrarCarpetas() throws IOException {
	...
	private static void mostrarFicherosDeCarpeta(File dir2) throws IOException {
		String ruta = UserDataCollector.getString("Introduce la ruta completa al directorio");
	...
	public static int menu() {
		...
		System.out.println("5. Mostrar arbol de directorios");
