...
public abstract class Persona {
	...
	public void enviarCorreo(String msg, Persona personaDestinatario) throws IESException {
		...
		if (this.getClass().equals(personaDestinatario.getClass()) && this.edad < 18) {
			throw new IESException("Lo sentimos, un alumno menor de edad solo puede enviar un mensaje a un profesor.");
		} else {
