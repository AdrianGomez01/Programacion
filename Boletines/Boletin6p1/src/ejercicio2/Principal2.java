 ...
 * 
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Equipo 1 \n" + equipo1.listadoDeAlumnos());
			System.out.println("Equipo 2 \n" + equipo2.listadoDeAlumnos());
			System.out.println("Equipo 3 \n" + equipo3.listadoDeAlumnos());
	...
	private static <T> void crearEquipo1(Equipo<Integer> equipo1) {
		Alumno<Integer> nuevoAlumno;


		try {
			nuevoAlumno = new Alumno(Integer.valueOf(4));
	...
	private static void crearEquipo2(Equipo<Integer> equipo2) throws EquipoException {
		Alumno nuevoAlumno;
		try {
	...
	private static void crearEquipo3(Equipo<Integer> equipo3) throws EquipoException {
		Alumno nuevoAlumno;
		try {
			nuevoAlumno = new Alumno("6", "Alumno 6");
